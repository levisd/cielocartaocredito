...
try {
    // Configure o SDK com meu merchant e o ambiente apropriado para criar a venda
    ...
    // Com o ID do pagamento, fazemos sua captura, se ela não tiver sido capturada ainda
    ...
    // Em caso de erros de integração, tratamos o erro aqui.
    // os códigos de erro disponíveis no manual de integração.
